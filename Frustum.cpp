...
Frustum::Frustum(float screenDepth, XMMATRIX viewMatrix, XMMATRIX projectionMatrix) :
...
void Frustum::UpdateFrustum(XMMATRIX viewMatrix, XMMATRIX projectionMatrix)
{
	...
	DirectX::XMStoreFloat4x4(&pMatrix, projectionMatrix);
	...
	projectionMatrix = DirectX::XMLoadFloat4x4(&pMatrix);
